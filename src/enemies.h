...
{
    int target_POWER;   // le nombre de POWER ennemis qui doivent être spawnées durant cette vague
    int target_POWERPS; // a quelle vitesse les POWER ennemis doivent spawn (Power Per Second)
